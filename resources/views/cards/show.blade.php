...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('cards.edit', $card->id) }}" class="btn btn-warning">
    ...
    <div class="row">
        <div class="col-md-6">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($card->racer)
                                    <a href="{{ route('racers.show', $card->racer->id) }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('cards.edit', $card->id) }}" class="btn btn-warning btn-block mb-2">
                ...
                <div class="card-body">
                    @if($card->racer)
                        ...
                        @if($card->racer->team)
                            <p>
                                <strong>Team:</strong> 
                                <a href="{{ route('teams.show', $card->racer->team->id) }}">
                        ...
                        @if($card->racer->image_url)
                            <p>
                                <img src="{{ $card->racer->image_url }}" 
                                     alt="{{ $card->racer->racer_name }}" 
                                     class="img-thumbnail" 
