                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('max_racer_per_team', 1) }}" 
                                   min="1">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('current_bto_session', 0) }}" 
                                   min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('bto_session_number', 0) }}" 
                                   min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('bto_limit_centiseconds', 150) }}"
                                   min="1">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('persiapan_delay', 2000) }}" 
                                   min="0"
                                   step="100">
                            <small class="form-text text-muted">Delay after "Persiapan reis ke X" announcement (default: 2000ms)</small>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('panggilan_delay', 1000) }}" 
                                   min="0"
                                   step="100">
