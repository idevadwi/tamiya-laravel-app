...
<div class="card">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('tournament.best_times.index') }}" class="form-inline"
            id="bestTimeFilterForm">
            <div class="col-md-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-warning edit-best-time"
                                        data-id="{{ $bestTime->id }}" data-team-id="{{ $bestTime->team_id }}"
                                        data-track="{{ $bestTime->track }}" data-timer="{{ $bestTime->timer }}"
                                        data-scope="{{ $bestTime->scope }}" data-session="{{ $bestTime->session_number }}"
                                        title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <form action="{{ route('tournament.best_times.destroy', $bestTime->id) }}" method="POST"
                                        class="d-inline"
...
<div class="alert alert-info">
    ...
    <ul class="mb-0">
        <li><strong>Overall:</strong> The best time throughout the entire tournament for a team on a specific track.
        </li>
        <li><strong>Session:</strong> The best time for a specific session (currently Session
            {{ $tournament->current_bto_session }}).
        </li>
        <li><strong>Auto-Update:</strong> When a session time beats the overall time, the overall time is automatically
            updated.</li>
...
<!-- Create Modal -->
<div class="modal fade" id="createBestTimeModal" tabindex="-1" role="dialog" aria-labelledby="createBestTimeModalLabel"
    aria-hidden="true">
            ...
            <form action="{{ route('tournament.best_times.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="create_timer">Timer (seconds:milliseconds) <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="create_timer" name="timer"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">
                                    ...
                                    <strong>Session:</strong> Best for current session
                                    ({{ $tournament->current_bto_session }})
                                </small>
                            </div>
                        </div>
...
<!-- Edit Modal -->
<div class="modal fade" id="editBestTimeModal" tabindex="-1" role="dialog" aria-labelledby="editBestTimeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="editBestTimeForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="edit_timer">Timer (seconds:milliseconds) <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="edit_timer" name="timer"
                                    placeholder="e.g., 14:20" pattern="\d{1,2}:\d{2}" required>
                                <small class="form-text text-muted">Format: MM:SS (e.g., 14:20)</small>
                            </div>
                        </div>
                    ...
                    <div class="row" id="edit_session_number_group" style="display: none;">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="edit_session_number">Session Number <span
                                        class="text-danger">*</span></label>
