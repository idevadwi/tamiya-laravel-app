...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('tournament.racers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('team_id') is-invalid @enderror" 
                                ...
                                @foreach($teams as $team)
                                    <option value="{{ $team->id }}" 
                                            {{ old('team_id', $selectedTeamId) == $team->id ? 'selected' : '' }}>
                                        {{ $team->team_name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <small class="form-text text-muted">
                                Select a team from the active tournament
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                Allowed types: jpeg, png, jpg, gif, svg. Max size: 2MB
                            </small>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Create Racer
                </button>
                <a href="{{ route('tournament.racers.index') }}" class="btn btn-default">
