...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">{{ __('messages.active_tournament') }}: <strong>{{ $activeTournament->tournament_name }}</strong></p>
        </div>
                ...
                <div class="card-body">
                    ...
                    @else
                        <p class="text-center text-muted py-3">
                            ...
                            <br>
                            <a href="{{ route('best_times.create') }}">{{ __('messages.record_one_now') }}</a>
                        </p>
                    @endif
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card card-warning card-outline">
                ...
                <div class="card-body">
                    ...
                    @else
                        <p class="text-center text-muted py-3">
                            <i class="fas fa-info-circle"></i> {{ __('messages.no_session_best_times', ['session' => $currentSession]) }}
                            <br>
                            <a href="{{ route('best_times.create') }}">{{ __('messages.record_one_now') }}</a>
                        </p>
                    @endif
