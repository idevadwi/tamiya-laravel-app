...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">Track Number: <strong>{{ $tournament->track_number }}</strong> ({{ $tournament->track_number * 3 }} lanes available)</p>
        </div>
        <a href="{{ route('races.index', request()->only(['stage', 'track', 'team_id'])) }}" class="btn btn-default">
        ...
        <form action="{{ route('races.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('card_id') is-invalid @enderror" 
                            id="card_id" 
                            name="card_id"
                            required>
