...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('racers.edit', $racer->id) }}" class="btn btn-warning">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('cards.create', ['racer_id' => $racer->id]) }}" class="btn btn-warning btn-block mb-2">
                        <i class="fas fa-credit-card"></i> Add Card
                    </a>
                    <a href="{{ route('racers.edit', $racer->id) }}" class="btn btn-secondary btn-block mb-2">
                        <i class="fas fa-edit"></i> Edit Racer
                    </a>
                    <form action="{{ route('racers.destroy', $racer->id) }}" 
                          method="POST" 
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('cards.create', ['racer_id' => $racer->id]) }}" class="btn btn-sm btn-warning">
                ...
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($cards as $card)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('cards.show', $card->id) }}" class="btn btn-sm btn-info" title="View">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('cards.create', ['racer_id' => $racer->id]) }}" class="btn btn-warning">
